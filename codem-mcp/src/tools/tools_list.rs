    ...
    json!({
        "tools": [
            ...
            },
            {
                ...
                "description": "Replace a small piece of text in a file. The old_str argument must be unique within the line range provided, unless you set allow_multiple_matches to true.",
